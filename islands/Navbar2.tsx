    ...
    >
      <div class="navbar bg-base-100">
        ...
        <div class="navbar-center">
          ...
          <a class="btn btn-ghost normal-case text-xl">Features</a>
          <a class="btn btn-ghost normal-case text-xl">Roadmap</a>
          <a class="btn btn-ghost normal-case text-xl">Pricing</a>
        </div>
